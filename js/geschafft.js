document.addEventListener('DOMContentLoaded', () => {
  ...
  const contentMap = {
    ...
    '3D-Veranstaltungen': {
      info: { url: 'https://hs-flensburg.de/sites/default/files/2025-06/Modulhandbuch_B-MI_23_05_2025.pdf#page=54', text: 'Info zu 3D-Animation' },
      reward: { url: 'Goodies/3D-Veranstaltungen/3D-Veranstaltung Goodies.zip', text: 'Wallpaper und Sticker' },
      images: [
    ...
    'GrundlagenGestaltung': {
      info: { url: 'https://hs-flensburg.de/sites/default/files/2025-06/Modulhandbuch_B-MI_23_05_2025.pdf#page=6', text: 'Info zu Grundlagen Gestaltung' },
      reward: { url: 'Goodies/GrundlagenGestaltung/GrundlagenGestaltung Goodies.zip', text: 'Wallpaper und Minecraft Skin' },
      images: [
